...
public class MainActivity extends Activity {
	...
	private LinearLayout graph_layout = null;
	...
	private static TextView mTV_count_time = null;
	private static WakeLock wakeLock = null;
	private static int averageIndex = 0;
	private static final int averageArraySize = 4;
	private static final int[] averageArray = new int[averageArraySize];

	private Button btn_beginCheck = null;
	...
	private void initConfig() {
		...
		graph_layout = (LinearLayout)findViewById(R.id.id_linearLayout_graph);
		...
		//将图表添加到布局中去
		graph_layout.addView(chart, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
		...
		mTV_count_time = (TextView) findViewById(R.id.id_tv_count_time);

		PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
//		wakeLock = pm.newWakeLock(PowerManager.FULL_WAKE_LOCK, "DoNotDimScreen");
		wakeLock = pm.newWakeLock(PowerManager.FULL_WAKE_LOCK,"PARTIAL_WAKE_LOCK:mywakeloke");

		btn_beginCheck = (Button)findViewById(R.id.btn_beginCheck);
		btn_beginCheck.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				mTV_count_time.setVisibility(View.VISIBLE);
				time.start();
				...
				btn_beginCheck.setVisibility(View.GONE);
			}
		});
	}
	...
	class TimeCount extends CountDownTimer {
		...
		public void onTick(long millisUntilFinished) {
			mTV_count_time.setVisibility(View.VISIBLE);
			mTV_count_time.setText(millisUntilFinished / 1000 + "秒");
		}
		@Override
		public void onFinish() {// 计时结束
			mTV_count_time.setVisibility(View.GONE);
			...
			btn_beginCheck.setVisibility(View.VISIBLE);
			btn_beginCheck.setText("重新检测");
		}
	}
}